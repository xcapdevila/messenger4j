...
[red]*[Since v.1.1.0]* [blue]*Added support for the Handover Protocol that allows passing the control between many apps (page inbox included).* Handover protocol allows you to have a bot as a primary receiver and a customer care agent (via page inbox) as a secondary receiver, among other setups.
