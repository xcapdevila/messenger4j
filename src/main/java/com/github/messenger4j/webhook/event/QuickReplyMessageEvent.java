...
public final class QuickReplyMessageEvent extends BaseEvent {
	...
	public QuickReplyMessageEvent(@NonNull String senderId, @NonNull String recipientId, @NonNull Instant timestamp, @NonNull BaseEventType baseEventType,
			@NonNull String messageId, @NonNull String text, @NonNull String payload, @NonNull Optional<PriorMessage> priorMessage) {
