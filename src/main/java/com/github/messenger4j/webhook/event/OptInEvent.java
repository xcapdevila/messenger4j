...
public final class OptInEvent extends BaseEvent {
	...
	public OptInEvent(@NonNull Optional<String> senderId, @NonNull String recipientId, @NonNull Instant timestamp, @NonNull BaseEventType baseEventType,
			@NonNull Optional<String> refPayload, @NonNull Optional<String> userRefPayload) {
		super(senderId.orElse(null), recipientId, timestamp, baseEventType);
	...
	public String senderId() {
		return Optional.ofNullable(super.senderId()).orElseThrow(() -> new UnsupportedOperationException(
