...
public final class PostbackEvent extends BaseEvent {
	...
	public PostbackEvent(@NonNull String senderId, @NonNull String recipientId, @NonNull Instant timestamp, @NonNull BaseEventType baseEventType,
			@NonNull String title, @NonNull Optional<String> payload, @NonNull Optional<Referral> referral, @NonNull Optional<PriorMessage> priorMessage) {
