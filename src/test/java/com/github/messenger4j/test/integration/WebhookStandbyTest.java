 ...
 * @since 1.1.0
 */
public class WebhookStandbyTest {
    ...
    public void shouldHandleAttachmentMessageEvent() throws Exception {
        ...
        assertThat(attachmentMessageEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandleOptInEventWithSenderId() throws Exception {
        ...
        assertThat(optInEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandleTextEchoMessageEvent() throws Exception {
        ...
        assertThat(messageEchoEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandleTemplateEchoMessageEvent() throws Exception {
        ...
        final String payload = "{\"object\":\"page\",\"entry\":[{\"id\":\"171999997131834678\",\"time\":1480120722215," +
                "\"standby\":[{\"sender\":{\"id\":\"17175299999834678\"},\"recipient\":{\"id\":\"1256299999730577\"}," +
    ...
    public void shouldHandleQuickReplyMessageEvent() throws Exception {
        ...
        assertThat(quickReplyMessageEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandleTextMessageEvent() throws Exception {
        ...
        assertThat(textMessageEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandlePostbackEvent() throws Exception {
        ...
        assertThat(postbackEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
        ...
        assertThat(postbackEvent.payload().isPresent(), equalTo(false));
    ...
    public void shouldHandleMeLinkReferralEvent() throws Exception {
        ...
        assertThat(referralEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandleAccountLinkingEventWithStatusLinked() throws Exception {
        ...
        assertThat(accountLinkingEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandleMessageReadEvent() throws Exception {
        ...
        assertThat(messageReadEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandleMessageDeliveredEventWithMids() throws Exception {
        ...
        assertThat(messageDeliveredEvent.baseEventType(), equalTo(BaseEventType.STANDBY));
    ...
    public void shouldHandleEventTypeThatIsUnsupported() throws Exception {
        ...
        assertThat(event.baseEventType(), equalTo(BaseEventType.STANDBY));
