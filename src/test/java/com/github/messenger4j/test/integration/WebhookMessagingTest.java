 ...
 * @since 1.1.0
 */
public class WebhookMessagingTest {
    ...
    public void shouldHandleAttachmentMessageEvent() throws Exception {
        ...
        assertThat(attachmentMessageEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleOptInEventWithSenderId() throws Exception {
        ...
        assertThat(optInEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleTextEchoMessageEvent() throws Exception {
        ...
        assertThat(messageEchoEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleQuickReplyMessageEvent() throws Exception {
        ...
        assertThat(quickReplyMessageEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleTextMessageEvent() throws Exception {
        ...
        assertThat(textMessageEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandlePostbackEvent() throws Exception {
        ...
        assertThat(postbackEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleMeLinkReferralEvent() throws Exception {
        ...
        assertThat(referralEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleAccountLinkingEventWithStatusLinked() throws Exception {
        ...
        assertThat(accountLinkingEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleMessageReadEvent() throws Exception {
        ...
        assertThat(messageReadEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleMessageDeliveredEventWithMids() throws Exception {
        ...
        assertThat(messageDeliveredEvent.baseEventType(), equalTo(BaseEventType.MESSAGING));
    ...
    public void shouldHandleEventTypeThatIsUnsupported() throws Exception {
        ...
        assertThat(event.baseEventType(), equalTo(BaseEventType.MESSAGING));
